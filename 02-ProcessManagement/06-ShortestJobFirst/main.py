...
class ShortestJobFirst(MDApp):
    '''
    `MDApp`-derived class automatically imports similarly named `.kv` file,
    i.e. `shortestjobfirst.kv`. Case-insensitive.
    '''

    title = "Process Management: Shortest Job First (SJF)"
    scheduling = core.SchedulingType.SJF
