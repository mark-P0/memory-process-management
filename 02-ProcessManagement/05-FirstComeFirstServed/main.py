...
class FirstComeFirstServed(MDApp):
    '''
    `MDApp`-derived class automatically imports similarly named `.kv` file,
    i.e. `firstcomefirstserved.kv`. Case-insensitive.
    '''

    title = "Process Management: First Come, First Served (FCFS)"
    scheduling = core.SchedulingType.FCFS
