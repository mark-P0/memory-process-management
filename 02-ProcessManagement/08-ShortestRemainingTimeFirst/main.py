...
class ShortestRemainingTimeFirst(MDApp):
    '''
    `MDApp`-derived class automatically imports similarly named `.kv` file,
    i.e. `shortestremainingtimefirst.kv`. Case-insensitive.
    '''

    title = "Process Management: Shortest Remaining Time First (SRTF)"
    scheduling = core.SchedulingType.SRTF
...
if __name__ == "__main__":
    inst = ShortestRemainingTimeFirst()
    inst.run()
