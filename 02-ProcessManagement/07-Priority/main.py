...
class PriorityScheduling(MDApp):
    '''
    `MDApp`-derived class automatically imports similarly named `.kv` file,
    i.e. `priorityscheduling.kv`. Case-insensitive.
    '''

    title = "Process Management: Priority Scheduling"
    scheduling = core.SchedulingType.Priority
