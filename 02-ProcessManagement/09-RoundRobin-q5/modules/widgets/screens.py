...
class HomeScreen(Screen):
    ...
    def validate_inputs(self, proc_container, quantum, scrmgr):
...
class LoadingScreen(Screen):
    ...
    def _prepare_data(self):
        ...
        ## Simulate processes
        sim = core.Simulation(procs_ready, scheduling, quantum)
    ...
    def _create_summary_screens(self, app):
        ...
        ## Reduce columns
        keep_cols = ["Process", "Arrival", "Burst", "Start", "Finish"]
